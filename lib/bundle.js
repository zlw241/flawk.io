...
class Game {
  constructor(canvas) {
    ...
    this.player = new __WEBPACK_IMPORTED_MODULE_1__player__["a" /* default */](50, 50, 75, this.playerDie.bind(this));
  ...
  addPlayer() {
    const player = new __WEBPACK_IMPORTED_MODULE_1__player__["a" /* default */](50, 50, 75, this.die);
    this.add(player);
  }
  ...
  addNectar(x, y) {
    ...
    const nectar = new __WEBPACK_IMPORTED_MODULE_3__nectar__["a" /* default */](xPos, yPos);
    this.add(nectar);
  }
