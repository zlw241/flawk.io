...
class GameView {
  ...
  updatePlayer(id, pos, speed, vel, radius, size, color, zombies) {
  ...
  draw(data) {
    Object.values(data.players).forEach((player) => {
      this.updatePlayer(player.id, player.pos, player.speed, player.vel, player.radius, player.size, player.color, player.zombies)
