...
var GameView = function () {
  ...
  _createClass(GameView, [{
    ...
    key: 'updatePlayer',
    value: function updatePlayer(id, pos, speed, vel, radius, size, color, zombies) {
    ...
    value: function draw(data) {
      ...
      Object.values(data.players).forEach(function (player) {
        _this.updatePlayer(player.id, player.pos, player.speed, player.vel, player.radius, player.size, player.color, player.zombies);
