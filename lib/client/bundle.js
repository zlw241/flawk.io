...
var GameView = function () {
  ...
  _createClass(GameView, [{
    ...
    key: 'updatePlayerPos',
    value: function updatePlayerPos(id, pos, speed, vel, radius, size, color, zombies) {
    ...
    value: function draw(data) {
      ...
      Object.values(data.players).forEach(function (player) {
        _this.updatePlayerPos(player.id, player.pos, player.speed, player.vel, player.radius, player.size, player.color, player.zombies);
      ...
      Object.values(data.nectar).forEach(function (nectar) {
        _this.game.addNectar(nectar.x, nectar.y, nectar.radius, nectar.color);
      });
