...
class GameServer {
  ...
  onDisconnect(socket) {
    ...
    console.log("players", Object.values(this.players).length, Object.values(this.game.players).length)
  ...
  startGame() {
    ...
    this.gameLoop = setInterval(this.stepGame.bind(this), 1000/60);
  }
  ...
  onMovePlayer(data) {
    // console.log(data.id, this.players[data.id].moveNum);
