...
class GameServer {
  ...
  stepGame() {
    ...
    // this.io.emit("update game", {players: this.game.playerData(), nectar: this.game.nectar, time: time});
  ...
  updateGame() {
    ...
    this.io.emit("update game", {players: playerData, nectar: {deleted: this.game.deletedNectar, moved: this.game.movedNectar}, time: time})
    this.game.deletedNectar = [];
    // this.io.emit("update game", {players: playerData, time: time})
  }
